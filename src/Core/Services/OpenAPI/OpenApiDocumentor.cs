...
namespace Azure.DataApiBuilder.Core.Services
{
    ...
    public class OpenApiDocumentor : IOpenApiDocumentor
    {
        ...
        public void CreateDocumentNewConfig(RuntimeConfigProvider runtimeNewConfigProvider, RuntimeConfig runtimeNewConfig)
        {
            _runtimeConfigProvider = runtimeNewConfigProvider;
            _runtimeConfig = runtimeNewConfig; // Properly assign the new config
            GenerateDocument(_runtimeConfigProvider, _runtimeConfig);
        }

        private void GenerateDocument(RuntimeConfigProvider runtimeNewConfigProvider, RuntimeConfig config)
        {
